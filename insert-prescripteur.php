...
if ($nom == "" || $prenom == "" || $email == "" || $tel == "" || $rue == "" || $code_postal == "" || $ville == "" || $etablissement == "" || $statut == "" || $login == "" || $mdp == "" || $conf_mdp == "") {
    ...
    if ($fichier == "") {
        ...
        if (($isa == "0") && ($isa1 == "0")) {
            if ($mdp == $conf_mdp) {
                $bdd->exec("INSERT INTO `prescripteur` (`photo`,`nom`,`prenom`,`tel`,`email`,`rue`,`code-postal`,`ville`,`etablissement`,`statut`,`login`,`mdp`) VALUES ('avatar.png','$nom','$prenom','$tel','$email','$adresse','$rue','$code_postal','$ville','$etablissement','$statut','$login','$mdp')") or die(print_r($bdd->ErrorInfo()));
